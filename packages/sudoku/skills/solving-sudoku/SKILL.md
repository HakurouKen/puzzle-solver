---
name: solving-sudoku
description: Use when a Sudoku puzzle (as a 9×9 number[][] array) is already decoded and confirmed by the user, and the puzzle now needs to be solved with step-by-step reasoning. Writes output.json (puzzle + solution + steps), then invokes rendering-sudoku to display the solved board.
---
